...
namespace Tusimaka.Models
{
    public class DBInit : DropCreateDatabaseAlways<DBContext>
    {
        ...
        {
            var Strekning1 = new strekning { fraFlyplass = "Bergen", tilFlyplass = "Oslo", dato = "2017-10-20", tid = "12:30", pris = "2350", flyTid= 45, antallLedigeSeter= 60 };
            var Strekning2 = new strekning { fraFlyplass = "Oslo", tilFlyplass = "Trondheim", dato = "2017-10-20", tid = "12:00", pris = "2250", flyTid = 55, antallLedigeSeter = 60 };
            var Strekning3 = new strekning { fraFlyplass = "Oslo", tilFlyplass = "Bergen", dato = "2017-10-20", tid = "13:00", pris = "2150", flyTid = 45, antallLedigeSeter = 60 };
            ...
            var Strekning11 = new strekning { fraFlyplass = "Trondheim", tilFlyplass = "Oslo", dato = "2017-10-21", tid = "17:00", pris = "1750", flyTid = 60, antallLedigeSeter = 60 };
